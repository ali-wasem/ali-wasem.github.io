...
1. **Authentication Screens :**
   This section includes options for sign up, log in, email verification, password reset, and social media login.

2. **Onboarding Screens :**
   beautifuly designed welcoming screens to the new users.

3. **Main Store Screen :**
   It's designed to be visually appealing and easy to navigate, with filters and sorting options to enhance the shopping experience.
